...
SYSTEM_PROMPT = (
    ...
    "into a small on-screen overlay for the candidate to study and rehearse. With explicit session "
    "consent, a separate candidate microphone may later be transcribed locally for coaching; that "
    "candidate response is kept logically separate from the friend's question and is never used as "
    "invented profile evidence. Address only the transcribed question and recent conversation.\n\n"
